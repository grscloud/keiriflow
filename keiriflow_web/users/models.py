...
class SystemPermission(models.Model):
    """全システム共通の細粒度権限マスタ"""
    code = models.CharField(max_length=50, primary_key=True, verbose_name="権限コード")
...
class User(AbstractUser, BaseModel):
    ...
    role = models.ForeignKey(Role, on_delete=models.SET_NULL, null=True, blank=True, related_name='users', verbose_name="役割・権限")
    ...
    def has_custom_perm(self, perm_code):
        ...
        return self.role.permissions.filter(code=perm_code, module__tenants=self.tenant).exists()
